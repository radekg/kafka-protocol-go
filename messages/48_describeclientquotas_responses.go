...
func init48DescribeClientQuotasResponse() []schema.Schema {
	...
	return []schema.Schema{
		...
		schema.NewSchema("DescribeClientQuotasResponse:v0",
			...
			&schema.Array{Name: FieldDescribeClientQuotasResponseEntries, Ty: schema.NewSchema("Entries:v0",
				&schema.Array{Name: FieldDescribeClientQuotasResponseEntriesEntity, Ty: schema.NewSchema("Entity:v0",
				...
				&schema.Array{Name: FieldDescribeClientQuotasResponseEntriesValues, Ty: schema.NewSchema("Values:v0",
		...
		schema.NewSchema("DescribeClientQuotasResponse:v1",
			...
			&schema.ArrayCompact{Name: FieldDescribeClientQuotasResponseEntries, Ty: schema.NewSchema("Entries:v1",
				&schema.ArrayCompact{Name: FieldDescribeClientQuotasResponseEntriesEntity, Ty: schema.NewSchema("Entity:v1",
				...
				&schema.ArrayCompact{Name: FieldDescribeClientQuotasResponseEntriesValues, Ty: schema.NewSchema("Values:v1",
