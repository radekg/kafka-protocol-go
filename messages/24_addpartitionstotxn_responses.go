...
func init24AddPartitionsToTxnResponse() []schema.Schema {
	...
	return []schema.Schema{
		...
		schema.NewSchema("AddPartitionsToTxnResponse:v0",
			...
			&schema.Array{Name: FieldAddPartitionsToTxnResponseResults, Ty: schema.NewSchema("[]AddPartitionsToTxnTopicResult:v0",
				&schema.Mfield{Name: FieldAddPartitionsToTxnResponseResultsName, Ty: schema.TypeStr},
				&schema.Array{Name: FieldAddPartitionsToTxnResponseResultsResults, Ty: schema.NewSchema("[]AddPartitionsToTxnPartitionResult:v0",
		...
		schema.NewSchema("AddPartitionsToTxnResponse:v1",
			&schema.Mfield{Name: FieldAddPartitionsToTxnResponseThrottleTimeMs, Ty: schema.TypeInt32},
			&schema.Array{Name: FieldAddPartitionsToTxnResponseResults, Ty: schema.NewSchema("[]AddPartitionsToTxnTopicResult:v1",
				&schema.Mfield{Name: FieldAddPartitionsToTxnResponseResultsName, Ty: schema.TypeStr},
				&schema.Array{Name: FieldAddPartitionsToTxnResponseResultsResults, Ty: schema.NewSchema("[]AddPartitionsToTxnPartitionResult:v1",
					&schema.Mfield{Name: FieldAddPartitionsToTxnResponseResultsResultsPartitionIndex, Ty: schema.TypeInt32},
					&schema.Mfield{Name: FieldAddPartitionsToTxnResponseResultsResultsErrorCode, Ty: schema.TypeInt16},
				)},
			)},
		...
		schema.NewSchema("AddPartitionsToTxnResponse:v2",
			&schema.Mfield{Name: FieldAddPartitionsToTxnResponseThrottleTimeMs, Ty: schema.TypeInt32},
			&schema.Array{Name: FieldAddPartitionsToTxnResponseResults, Ty: schema.NewSchema("[]AddPartitionsToTxnTopicResult:v2",
				&schema.Mfield{Name: FieldAddPartitionsToTxnResponseResultsName, Ty: schema.TypeStr},
				&schema.Array{Name: FieldAddPartitionsToTxnResponseResultsResults, Ty: schema.NewSchema("[]AddPartitionsToTxnPartitionResult:v2",
					&schema.Mfield{Name: FieldAddPartitionsToTxnResponseResultsResultsPartitionIndex, Ty: schema.TypeInt32},
					&schema.Mfield{Name: FieldAddPartitionsToTxnResponseResultsResultsErrorCode, Ty: schema.TypeInt16},
				)},
			)},
		...
		schema.NewSchema("AddPartitionsToTxnResponse:v3",
			&schema.Mfield{Name: FieldAddPartitionsToTxnResponseThrottleTimeMs, Ty: schema.TypeInt32},
			&schema.ArrayCompact{Name: FieldAddPartitionsToTxnResponseResults, Ty: schema.NewSchema("[]AddPartitionsToTxnTopicResult:v3",
				&schema.Mfield{Name: FieldAddPartitionsToTxnResponseResultsName, Ty: schema.TypeStrCompact},
				&schema.ArrayCompact{Name: FieldAddPartitionsToTxnResponseResultsResults, Ty: schema.NewSchema("[]AddPartitionsToTxnPartitionResult:v3",
					&schema.Mfield{Name: FieldAddPartitionsToTxnResponseResultsResultsPartitionIndex, Ty: schema.TypeInt32},
					&schema.Mfield{Name: FieldAddPartitionsToTxnResponseResultsResultsErrorCode, Ty: schema.TypeInt16},
