...
func init47OffsetDeleteResponse() []schema.Schema {
	...
	return []schema.Schema{
		...
		schema.NewSchema("OffsetDeleteResponse:v0",
			...
			&schema.Array{Name: FieldOffsetDeleteResponseTopics, Ty: schema.NewSchema("Topics:v0",
				&schema.Mfield{Name: FieldOffsetDeleteResponseTopicsName, Ty: schema.TypeStr},
				&schema.Array{Name: FieldOffsetDeleteResponseTopicsPartitions, Ty: schema.NewSchema("Partitions:v0",
