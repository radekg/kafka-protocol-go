...
func init46ListPartitionReassignmentsResponse() []schema.Schema {
	...
	return []schema.Schema{
		...
		schema.NewSchema("ListPartitionReassignmentsResponse:v0",
			...
			&schema.ArrayCompact{Name: FieldListPartitionReassignmentsResponseTopics, Ty: schema.NewSchema("Topics:v0",
				&schema.Mfield{Name: FieldListPartitionReassignmentsResponseTopicsName, Ty: schema.TypeStrCompact},
				&schema.ArrayCompact{Name: FieldListPartitionReassignmentsResponseTopicsPartitions, Ty: schema.NewSchema("Partitions:v0",
