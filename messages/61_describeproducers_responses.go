...
func init61DescribeProducersResponse() []schema.Schema {
	...
	return []schema.Schema{
		...
		schema.NewSchema("DescribeProducersResponse:v0",
			...
			&schema.ArrayCompact{Name: FieldDescribeProducersResponseTopics, Ty: schema.NewSchema("[]TopicResponse:v0",
				&schema.Mfield{Name: FieldDescribeProducersResponseTopicsName, Ty: schema.TypeStrCompact},
				&schema.ArrayCompact{Name: FieldDescribeProducersResponseTopicsPartitions, Ty: schema.NewSchema("[]PartitionResponse:v0",
					...
					&schema.ArrayCompact{Name: FieldDescribeProducersResponseTopicsPartitionsActiveProducers, Ty: schema.NewSchema("[]ProducerState:v0",
