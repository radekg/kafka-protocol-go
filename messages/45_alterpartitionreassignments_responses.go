...
func init45AlterPartitionReassignmentsResponse() []schema.Schema {
	...
	return []schema.Schema{
		...
		schema.NewSchema("AlterPartitionReassignmentsResponse:v0",
			...
			&schema.ArrayCompact{Name: FieldAlterPartitionReassignmentsResponseResponses, Ty: schema.NewSchema("[]ReassignableTopicResponse:v0",
				&schema.Mfield{Name: FieldAlterPartitionReassignmentsResponseResponsesName, Ty: schema.TypeStrCompact},
				&schema.ArrayCompact{Name: FieldAlterPartitionReassignmentsResponseResponsesPartitions, Ty: schema.NewSchema("[]ReassignablePartitionResponse:v0",
