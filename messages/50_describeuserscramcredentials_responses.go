...
func init50DescribeUserScramCredentialsResponse() []schema.Schema {
	...
	return []schema.Schema{
		...
		schema.NewSchema("DescribeUserScramCredentialsResponse:v0",
			...
			&schema.ArrayCompact{Name: FieldDescribeUserScramCredentialsResponseResults, Ty: schema.NewSchema("Results:v0",
				...
				&schema.ArrayCompact{Name: FieldDescribeUserScramCredentialsResponseResultsCredentialInfos, Ty: schema.NewSchema("CredentialInfos:v0",
