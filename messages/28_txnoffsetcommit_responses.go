...
func init28TxnOffsetCommitResponse() []schema.Schema {
	...
	return []schema.Schema{
		...
		schema.NewSchema("TxnOffsetCommitResponse:v0",
			...
			&schema.Array{Name: FieldTxnOffsetCommitResponseTopics, Ty: schema.NewSchema("[]TxnOffsetCommitResponseTopic:v0",
				&schema.Mfield{Name: FieldTxnOffsetCommitResponseTopicsName, Ty: schema.TypeStr},
				&schema.Array{Name: FieldTxnOffsetCommitResponseTopicsPartitions, Ty: schema.NewSchema("[]TxnOffsetCommitResponsePartition:v0",
		...
		schema.NewSchema("TxnOffsetCommitResponse:v1",
			&schema.Mfield{Name: FieldTxnOffsetCommitResponseThrottleTimeMs, Ty: schema.TypeInt32},
			&schema.Array{Name: FieldTxnOffsetCommitResponseTopics, Ty: schema.NewSchema("[]TxnOffsetCommitResponseTopic:v1",
				&schema.Mfield{Name: FieldTxnOffsetCommitResponseTopicsName, Ty: schema.TypeStr},
				&schema.Array{Name: FieldTxnOffsetCommitResponseTopicsPartitions, Ty: schema.NewSchema("[]TxnOffsetCommitResponsePartition:v1",
					&schema.Mfield{Name: FieldTxnOffsetCommitResponseTopicsPartitionsPartitionIndex, Ty: schema.TypeInt32},
					&schema.Mfield{Name: FieldTxnOffsetCommitResponseTopicsPartitionsErrorCode, Ty: schema.TypeInt16},
				)},
			)},
		...
		schema.NewSchema("TxnOffsetCommitResponse:v2",
			&schema.Mfield{Name: FieldTxnOffsetCommitResponseThrottleTimeMs, Ty: schema.TypeInt32},
			&schema.Array{Name: FieldTxnOffsetCommitResponseTopics, Ty: schema.NewSchema("[]TxnOffsetCommitResponseTopic:v2",
				&schema.Mfield{Name: FieldTxnOffsetCommitResponseTopicsName, Ty: schema.TypeStr},
				&schema.Array{Name: FieldTxnOffsetCommitResponseTopicsPartitions, Ty: schema.NewSchema("[]TxnOffsetCommitResponsePartition:v2",
					&schema.Mfield{Name: FieldTxnOffsetCommitResponseTopicsPartitionsPartitionIndex, Ty: schema.TypeInt32},
					&schema.Mfield{Name: FieldTxnOffsetCommitResponseTopicsPartitionsErrorCode, Ty: schema.TypeInt16},
				)},
			)},
		...
		schema.NewSchema("TxnOffsetCommitResponse:v3",
			&schema.Mfield{Name: FieldTxnOffsetCommitResponseThrottleTimeMs, Ty: schema.TypeInt32},
			&schema.ArrayCompact{Name: FieldTxnOffsetCommitResponseTopics, Ty: schema.NewSchema("[]TxnOffsetCommitResponseTopic:v3",
				&schema.Mfield{Name: FieldTxnOffsetCommitResponseTopicsName, Ty: schema.TypeStrCompact},
				&schema.ArrayCompact{Name: FieldTxnOffsetCommitResponseTopicsPartitions, Ty: schema.NewSchema("[]TxnOffsetCommitResponsePartition:v3",
					&schema.Mfield{Name: FieldTxnOffsetCommitResponseTopicsPartitionsPartitionIndex, Ty: schema.TypeInt32},
					&schema.Mfield{Name: FieldTxnOffsetCommitResponseTopicsPartitionsErrorCode, Ty: schema.TypeInt16},
